...
<body class="main">
	...
	<div class="content">
		<h1>Register Form</h1>
		<form action="<?= base_url();?>register/" method="post" name="register_form" id="register_form">
			<div class="container">
				<!-- メール入力 -->
				<label><b><?= $this->lang->line('email'); ?></b></label>
				<input type="text" name="email" id="email" value="<?= set_value("email"); ?>" placeholder="<?= $this->lang->line('placeholder_email'); ?>" /> 
				...
				<!-- 登録ボタン -->
				<button type="submit"><?= $this->lang->line('register_btn'); ?></button>
			</div> 
		</form>
		<div class="fb_login">
			<a href="<?= base_url(); ?>login" style="float: left;"><?= $this->lang->line('back_login'); ?></a>
		</div>
	</div>
</body>
</html>